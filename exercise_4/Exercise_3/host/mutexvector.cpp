...
static void *writer(void *arg){
    ...
    while(true){
        {
            //Create a local scope for ScopeLocker
            //Critical section
            ScopedLocker scopelock(mtx);
            ...
            //Destructor for ScopeLocker called as it's out of scope
        }

        sleep(1); //Sleep is not a critical section
    }
